                ...
                <div class="view-port clearfix" id="chat">
                    <div class="view bg-white">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/1x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/2x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/3x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/4x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/5x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/6x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/7x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/8x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/9x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" src="{{ asset('temp/assets/img/profiles/1x.jpg') }}" class="col-top">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/2x.jpg" data-src="temp/assets/img/profiles/2.jpg" src="{{ asset('temp/assets/img/profiles/2x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/3x.jpg" data-src="temp/assets/img/profiles/3.jpg" src="{{ asset('temp/assets/img/profiles/3x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/4x.jpg" data-src="temp/assets/img/profiles/4.jpg" src="{{ asset('temp/assets/img/profiles/4x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/5x.jpg" data-src="temp/assets/img/profiles/5.jpg" src="{{ asset('temp/assets/img/profiles/5x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/6x.jpg" data-src="temp/assets/img/profiles/6.jpg" src="{{ asset('temp/assets/img/profiles/6x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/7x.jpg" data-src="temp/assets/img/profiles/7.jpg" src="{{ asset('temp/assets/img/profiles/7x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/8x.jpg" data-src="temp/assets/img/profiles/8.jpg" src="{{ asset('temp/assets/img/profiles/8x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/9x.jpg" data-src="temp/assets/img/profiles/9.jpg" src="{{ asset('temp/assets/img/profiles/9x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="temp/assets/img/profiles/1x.jpg" data-src="temp/assets/img/profiles/1.jpg" src="{{ asset('temp/assets/img/profiles/1x.jpg') }}" class="col-top">
                        </span>
                                            <p class="p-l-10 ">
                        ...
                        <div class="chat-inner" id="my-conversation">
                            ...
                            <div class="message clearfix">
                                <div class="profile-img-wrapper m-t-5 inline">
                                    <img class="col-top" width="30" height="30" src="{{ asset('temp/assets/img/profiles/avatar_small.jpg') }}" alt="">
                                </div>
