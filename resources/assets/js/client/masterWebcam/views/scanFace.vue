<template>
    <div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <vue-webcam ref='webcam' v-if="cekOncamera1 == 1" :width="400" :height="400"></vue-webcam>
                            </div>
                        </div>
                        <div class="row">
        ...
        <!-- Modal -->
        <div class="modal fade fill-in show" id="cameraCheckFace" tabindex="-1" role="dialog" aria-hidden="true">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                <i class="pg-close"></i>
            </button>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <vue-webcam ref='webcam2' v-if="cekOncamera2 == 1" :width="400" :height="400"></vue-webcam>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 text-center p-b-5">
                                <button type="button" @click="takePhotoForCheck"  class="btn btn-primary btn-lg btn-large fs-15">Take Picture</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods:{
            uploadImg(){
                ...
                axios.post('../api/masterWebcam/addData', dataInput)
                    .then((response) => {
